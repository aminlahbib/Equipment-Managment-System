    ...
    <div className="min-h-screen bg-background text-text-primary relative overflow-hidden transition-colors duration-300">
      ...
      <header className="absolute top-0 w-full p-6 flex justify-between items-center z-20 max-w-7xl mx-auto left-0 right-0">
        ...
        <div className="flex gap-4">
           <Button variant="ghost" className="hidden sm:inline-flex text-text-secondary hover:text-text-primary">Documentation</Button>
      ...
      <main className="relative pt-32 pb-16 px-6 sm:pt-48 sm:pb-24 lg:pb-32 max-w-7xl mx-auto text-center z-10">
        ...
        {/* Feature Grid */}
        <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8 text-left animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          <div className="p-8 rounded-2xl bg-surface border border-border hover:border-text-secondary/20 transition-colors">
            ...
            <p className="text-text-secondary leading-relaxed text-sm">Instant search and booking. Built on a modern stack for zero latency interactions.</p>
          </div>
          <div className="p-8 rounded-2xl bg-surface border border-border hover:border-text-secondary/20 transition-colors">
            ...
            <p className="text-text-secondary leading-relaxed text-sm">Role-based access control and detailed audit logs keep your inventory safe.</p>
          </div>
          <div className="p-8 rounded-2xl bg-surface border border-border hover:border-text-secondary/20 transition-colors">
            ...
            <p className="text-text-secondary leading-relaxed text-sm">Cloud-native architecture means you can manage your gear from any device.</p>
          </div>
        </div>
